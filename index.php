...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <h1>
        <a href="#" class="logo">Beans<span class="span">grill.</span></a>
      </h1>
      ...
      <div class="header-btn-group">
        ...
        <button class="btn btn-hover"><a href="menu.php">Order now</a></button>
...
<!-- search end  -->
  ...
  <main>
    <article>
      ...
      <section class="hero" id="home" style="background-image: url('./assets/images/melanie-magdalena-KpBAYMNf9Tw-unsplash.jpg')">
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <button class="btn"><a href="menu.php">Order now</a></button>
      ...
      <section class="section section-divider gray about" id="about">
        <div class="container">
          ...
          <div class="about-content">
            ...
            <button class="btn btn-hover"><a href="">Learn More</a></button>
    ...
    <div class="footer-top" style="background-image: url('./assets/images/footer-illustration.png')">
      <div class="container">
        ...
        <div class="footer-brand">
          ...
          <a href="" class="logo">Fun and Food<span class="span">.</span></a>
        ...
        <ul class="footer-list">
          ...
          <li>
            <p class="footer-list-item">Info@Funfood.com</p>
          </li>
        ...
        <ul class="footer-list">
          ...
          <li>
            <p class="footer-list-item">Monday-Friday: 08:00-10:00</p>
          </li>

          <li>
            <p class="footer-list-item">Tuesday 6PM: Till Mid Night</p>
          </li>

          <li>
            <p class="footer-list-item">Saturday: 10:00-5:00</p>
          </li>
